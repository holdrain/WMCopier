...
def Options():
    ...
    parser.add_argument('--img_num', type=int, default=5000)
    ...
    parser.add_argument('--output_dir', type=str, default='aux')
...
if __name__ == '__main__':
    ...
    set_seeds(2025)
    if opt.test:
        opt.output_dir = opt.output_dir + '/test'
    else:
        opt.output_dir = opt.output_dir + '/train'
